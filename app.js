...
function home(){
  $("#app").innerHTML='<section class="container hero"><div><div class="eyebrow">STUDENT-LED LEARNING COMMUNITY</div><h1>一起学习，<br>互相帮助，<br>让知识<strong>留下来。</strong></h1><p>Episteme 知屿是一个由高中生发起并主导的线上学习共同体。把问题问出来，把答案留下来，再把理解分享给下一个人。</p><div class="actions-row"><a class="primary" href="#/community">进入讨论群 →</a><a class="secondary" href="#/library">浏览资源库</a></div></div><div class="hero-art"><div class="mountain one"></div><div class="mountain two"></div><div class="water"></div><div class="hero-mark"><img src="logo.png"><b>Episteme 知屿</b><span>TRUE KNOWLEDGE BELONGS TO NO ONE.</span></div></div></section><section class="section"><div class="container"><h2>Ask → Discuss → Understand → Preserve → Share</h2><div class="grid"><div class="card"><h3>讨论</h3><p>提出问题，把思路讲清楚。</p></div><div class="card"><h3>资源</h3><p>查看和分享经过审核的资料。</p></div><div class="card"><h3>录课</h3><p>按学科进入课程，直接观看。</p></div></div></div></section><section class="section"><div class="container"><h2>学科</h2><div class="chips">'+subjects.map(s=>'<span class="chip">'+esc(s.name)+'</span>').join("")+'</div></div></section>';
}
